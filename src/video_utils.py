...
def decode_video_frames_torchcodec(
    ...
    decoder = VideoDecoder(video_path, device=device, seek_mode="approximate", output_dtype="auto")
    loaded_frames = []
    loaded_ts = []
    ...
    if metadata.pixel_format == "gray12le":
        closest_frames = (closest_frames * 4096).type(torch.float32)
    else:
